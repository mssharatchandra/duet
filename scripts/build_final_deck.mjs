...
const specs = [
  ...
  { n: 5, title: "The waterfall tax", kind: "waterfall", body: ["speech end", "endpoint", "ASR", "reasoning", "TTS", "playback"], source: "Decision 0021 · docs/LATENCY_ARCHITECTURE.md" },
  { n: 6, title: "Fast models do not guarantee a fast conversation", kind: "owners", body: ["turn timing", "reasoning", "speech start", "playout"], source: "Duet latency architecture" },
  { n: 7, title: "Duet’s thesis: guarded speculative duplex", kind: "speculation", body: ["Start safe work early.", "Commit only when meaning is stable.", "Cancel everything stale."], source: "Duet architecture; concurrency is prior art" },
  { n: 8, title: "Concurrent lanes, causal gates", kind: "lanes", rows: [["LISTEN", "continuous audio"], ["TURN", "partial  →  stable  →  final"], ["POLICY", "consent · opt-out · barge-in · claims"], ["PLAN", "retrieval · reasoning"], ["ACT", "tool request"], ["SPEAK", "safe clause  →  audio"]], source: "Duet runtime lanes" },
  { n: 9, title: "What runs inside Aira", kind: "architecture", body: ["Browser", "Saaras", "Duet", "Gemini", "Bulbul", "Speaker"], source: "Duet Aira browser demo architecture" },
