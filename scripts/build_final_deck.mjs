...
const specs = [
  ...
  { n: 3, title: "The 80/20 glossary", kind: "glossary", rows: [["VAD", "Is someone speaking?"], ["ASR / STT", "What did they say?"], ["EOU / endpoint", "Are they finished?"], ["LLM TTFT", "First thinking token"], ["TTS TTFB", "First playable audio"], ["Barge-in", "Caller takes the floor"], ["RTF", "Inference keeps up with real time"]], source: "Duet learning guide" },
